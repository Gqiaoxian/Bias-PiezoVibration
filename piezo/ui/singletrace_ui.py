...
class Ui_singletrace(object):
    def setupUi(self, singletrace):
        ...
        self.piezo_checkBox = QCheckBox(self.groupBox_4)
        self.piezo_checkBox.setObjectName(u"piezo_checkBox")
        self.piezo_checkBox.setChecked(True)

        self.verticalLayout_3.addWidget(self.piezo_checkBox)
    ...
    def retranslateUi(self, singletrace):
        ...
        self.piezo_checkBox.setText(QCoreApplication.translate("singletrace", u"Piezo", None))
