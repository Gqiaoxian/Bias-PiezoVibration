...
class _TdmsChunkLoadWorker(QObject):
    ...
    def __init__(self, file_path, keyPara=None):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            with TdmsFile.open(self.file_path) as tdmsFile:
...
class DebugWaveformWidget(QWidget):
    ...
    def _start_async_load(self):
        ...
        self._load_worker = _TdmsChunkLoadWorker(file_path, keyPara)
    ...
    def _on_load_finished(self, df_bias, df_V):
        ...
        try:
            ...
            if keyPara and keyPara.get('mode') == 'RE_Irregular_Vabration':
                ...
                self.current_logG = DataProcessUtil.log_G_trans(df_V, df_bias, g0, a1, b1, a2, b2)
